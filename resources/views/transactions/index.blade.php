...
@section('content')
    ...
    <div class="table-responsive">
            ...
            <div class="col-md-4">
                <div class="card p-3">
                    <div class="d-flex justify-content-between flex-row h-full align-items-center">
                        ...
                        <div>
                            <svg class="text-success" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="col-md-4">
                <div class="card p-3">
                    <div class="d-flex justify-content-between flex-row h-full align-items-center">
                        ...
                        <div>
                            <svg class="text-danger" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('transactions.create') }}" class="btn btn-primary mb-4">Add Trasaction</a>
        </div>
